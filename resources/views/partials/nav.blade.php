<!-- <nav
    ...
    <div class="navbar-nav-right d-flex align-items-center justify-content-end" id="navbar-collapse">
        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown">
            ...
            <li>
                <a class="dropdown-item mt-0" href="{{ panel_route('user.index') }}">
            ...
            <li>
                <a class="dropdown-item" href="{{ panel_route('user.edit', ['id' => auth()->id()]) }}">
                    <i class="icon-base ti tabler-user me-3 icon-md"></i>
                    <span class="align-middle">Thông tin cá nhân</span>
                </a>
            </li>
            <li>
                <a class="dropdown-item" href="{{ panel_route('setting.index') }}">
                <i class="icon-base ti tabler-settings me-3 icon-md"></i
                ><span class="align-middle">Cấu hình Site</span>
                </a>
            </li>
            <li>
                <div class="d-grid px-2 pt-2 pb-1">
                <a class="btn btn-sm btn-danger d-flex" href="{{ panel_route('auth.logout') }}">
    ...
    <ul class="navbar-nav gap-1 nav-right-links align-items-center">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="avascript:;" data-bs-toggle="dropdown"><img
            src="{{ asset('assets/images/county/02.png') }}" width="22" alt="">
        </a>
        <ul class="dropdown-menu dropdown-menu-end">
