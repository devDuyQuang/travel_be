            ...
            <div class="tab-pane fade show active" id="cinfo-main" role="tabpanel" aria-labelledby="cinfo-main-tab">
              <div class="row g-3">
                ...
                <div class="col-md-12">
                  ...
                  <textarea name="description" class="form-control" rows="3" placeholder="Reach out for support, feedback, or to schedule an appointment...">{{ $v['description'] ?? '' }}</textarea>
                </div>
                ...
                <hr class="my-2">
                <div class="col-md-12">
                  <label class="form-label fw-bold d-block text-primary"><i class="ti tabler-users me-1"></i>Thanh Thống kê (Talk to doctors...)</label>
                  <div class="row g-2">
                    <div class="col-12">
                      <input type="text" name="stats_text" class="form-control form-control-sm" value="{{ $v['stats_text'] ?? '' }}" placeholder="Talk to over 215 doctor">
                    </div>
                  </div>
                </div>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="cinfo-main" role="tabpanel">
              <div class="row g-3">
                <div class="col-md-12">
                  ...
                  <input type="text" name="title" class="form-control" value="{{ $v['title'] ?? '' }}" placeholder="Kết nối với phòng khám">
                </div>

                <div class="col-md-12">
                  <label class="form-label fw-bold">Mô tả</label>
                  <textarea name="description" class="form-control" rows="3" placeholder="Chúng tôi luôn sẵn sàng hỗ trợ...">{{ $v['description'] ?? '' }}</textarea>
                </div>

                <hr class="my-2">

                <div class="col-md-12">
                  <label class="form-label fw-bold d-block text-primary">
                    <i class="ti tabler-map-pin me-1"></i>Địa chỉ
                  </label>
                  <div class="row g-2">
                    <div class="col-4">
                      <input type="text" name="address[label]" class="form-control form-control-sm" value="{{ $v['address']['label'] ?? '' }}" placeholder="Địa chỉ">
                    </div>
                    <div class="col-8">
                      <input type="text" name="address[value]" class="form-control form-control-sm" value="{{ $v['address']['value'] ?? '' }}" placeholder="Nhập địa chỉ phòng khám">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <label class="form-label fw-bold d-block text-primary">
                    <i class="ti tabler-phone me-1"></i>Điện thoại
                  </label>
                  <div class="row g-2">
                    <div class="col-4">
                      <input type="text" name="phone[label]" class="form-control form-control-sm" value="{{ $v['phone']['label'] ?? '' }}" placeholder="Điện thoại">
                    </div>
                    <div class="col-8">
                      <input type="text" name="phone[value]" class="form-control form-control-sm" value="{{ $v['phone']['value'] ?? '' }}" placeholder="0901 234 567">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  ...
                  <div class="row g-2">
                    <div class="col-4">
                      <input type="text" name="email[label]" class="form-control form-control-sm" value="{{ $v['email']['label'] ?? '' }}" placeholder="Email">
                    </div>
                    <div class="col-8">
                      <input type="text" name="email[value]" class="form-control form-control-sm" value="{{ $v['email']['value'] ?? '' }}" placeholder="email@domain.com">
                    </div>
                ...
                <div class="col-md-12">
                  <label class="form-label fw-bold d-block text-primary">
                    <i class="ti tabler-clock me-1"></i>Giờ làm việc
                  </label>
                  <div class="row g-2">
                    <div class="col-4">
                      <input type="text" name="time[label]" class="form-control form-control-sm" value="{{ $v['time']['label'] ?? '' }}" placeholder="Giờ làm việc">
                    </div>
                    <div class="col-8">
                      <textarea name="time[value]" class="form-control form-control-sm" rows="3" placeholder="Thứ 2 - Thứ 6: 08:00 - 17:00">{{ $v['time']['value'] ?? '' }}</textarea>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <label class="form-label fw-bold d-block text-primary">
                    <i class="ti tabler-users me-1"></i>Thanh thống kê
                  </label>
                  <input type="text" name="stats_text" class="form-control form-control-sm" value="{{ $v['stats_text'] ?? '' }}" placeholder="Đồng hành cùng đội ngũ bác sĩ chuyên khoa">
                </div>

                <div class="col-md-12">
                  <label class="form-label fw-bold d-block text-primary">
                    <i class="ti tabler-star me-1"></i>Đánh giá
                  </label>
                  <div class="row g-2">
                    <div class="col-4">
                      <input type="text" name="rating[score]" class="form-control form-control-sm" value="{{ $v['rating']['score'] ?? '' }}" placeholder="4.8">
                    ...
                    <div class="col-8">
                      <input type="text" name="rating[text]" class="form-control form-control-sm" value="{{ $v['rating']['text'] ?? '' }}" placeholder="Đánh giá tích cực từ khách hàng">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <label class="form-label fw-bold d-block text-primary">
                    <i class="ti tabler-map me-1"></i>Mã nhúng bản đồ
                  </label>
                  <textarea name="map_iframe" class="form-control font-monospace" rows="3" placeholder='<iframe src="https://www.google.com/maps/embed?..."></iframe>'>{{ $v['map_iframe'] ?? '' }}</textarea>
                </div>
              </div>
            </div>
            ...
            <div class="tab-pane fade" id="cinfo-appt" role="tabpanel">
              <div class="row g-3">
                <div class="col-12">
                  <label class="form-label fw-bold">Text hiển thị</label>
                  <input type="text" name="appointment_btn[text]" class="form-control" value="{{ $v['appointment_btn']['text'] ?? '' }}" placeholder="Đặt lịch khám">
                </div>

                <div class="col-12">
                  <label class="form-label fw-bold">Link liên kết</label>
                  <input type="text" name="appointment_btn[link]" class="form-control" value="{{ $v['appointment_btn']['link'] ?? '' }}" placeholder="/dat-lich-kham">
                </div>
              </div>
            </div>
            ...
            <div class="tab-pane fade" id="cinfo-form" role="tabpanel">
              <div class="row g-3">
                <div class="col-12">
                  ...
                  <input type="text" name="form_title" class="form-control" value="{{ $v['form_title'] ?? 'Gửi Liên Hệ' }}" placeholder="Gửi Liên Hệ">
                </div>

                <div class="col-12">
                  <label class="form-label fw-bold">Mô tả form liên hệ</label>
                  <input type="text" name="form_subtitle" class="form-control" value="{{ $v['form_subtitle'] ?? 'Chúng tôi sẽ phản hồi sớm nhất để hỗ trợ bạn.' }}" placeholder="Chúng tôi sẽ phản hồi sớm nhất để hỗ trợ bạn.">
                </div>
              </div>
            </div>
