   ...
   <x-tab-form
      ...
      <x-slot name="home">
         ...
         <x-select-field
            ...
            :options="$parents"
            :value="old('parent_id')"  {{-- hoặc :value="$model->parent_id ?? old('parent_id')" khi edit --}}
            id="parent_id"
         ...
         <x-file-input label="Icon" name="icon_file" :multiple="false" />
         <div class="mb-6">
            ...
            >
               ...
               <option value="Service" @selected(old('type', 'Post') === 'Service')>Service</option>
            </select>
